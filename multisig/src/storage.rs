...
pub trait StorageModule {
    ...
    /// Mapping between ERC20 Ethereum address and Dharitri DCT Token Identifiers
    ...
    #[view(getDctSafeAddress)]
    #[storage_mapper("dctSafeAddress")]
    fn dct_safe_address(&self) -> SingleValueMapper<ManagedAddress>;

    #[view(getMultiTransferDctAddress)]
    #[storage_mapper("multiTransferDctAddress")]
    fn multi_transfer_dct_address(&self) -> SingleValueMapper<ManagedAddress>;
}
